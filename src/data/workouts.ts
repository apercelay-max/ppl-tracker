...
// État actuel : PHASE 0 — DÉCHARGE (16→23/07/2026). 2 séries de travail par
// exercice, RIR 3-4, charges réduites d'≈10 % par rapport à la cible Sem 1
// sèche. Zéro échec, zéro technique d'intensification — sas de calibration,
// pas un bloc d'entraînement (récup post-ski + purge de fatigue).
// ⚠️ Suite prévue le 24/07/2026 : "Phase 0bis" (3 séries/exo, RIR 2-3,
// charges -5 %) — à intégrer dans une prochaine mise à jour de ce fichier
// quand Léo enverra le programme_hypertrophie_PPL_Strict_V11_Phase0bis.xlsx.
...
export const WORKOUTS: WorkoutDay[] = [
  // ── JOUR 1 — PULL A ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 1,
    name: 'Pull A',
    focus: 'Épaisseur du dos + priorité deltoïde postérieur (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
    muscleGroups: 'Dos / Deltoïde postérieur / Biceps',
    estimatedDuration: '≈ 33 min',
    exercises: [
      {
        id: 'pull-a-1',
  ...
  // ── JOUR 2 — PUSH A ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 2,
    name: 'Push A',
    focus: 'Deltoïdes priorité 1 à froid, aucun développé vertical (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
  ...
  // ── JOUR 3 — LEGS A ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 3,
    name: 'Legs A',
    focus: 'Récup active post-ski (unilatéral), priorité fessiers (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
    muscleGroups: 'Fessiers / Quadriceps / Ischios / Mollets + Abdos',
    estimatedDuration: '≈ 29 min',
    exercises: [
      {
        id: 'legs-a-1',
  ...
  // ── JOUR 4 — PULL B ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 4,
    name: 'Pull B',
    focus: 'Largeur du dos + volume deltoïde postérieur (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
    muscleGroups: 'Dos / Deltoïde postérieur / Biceps',
  ...
  // ── JOUR 5 — PUSH B ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 5,
    name: 'Push B',
    focus: 'Deltoïdes priorité 1 (poulie) + pecs sterno-costal, aucun développé vertical (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
    muscleGroups: 'Épaules / Pecs / Triceps',
    ...
    exercises: [
      ...
      },
      {
        ...
        supersetOrder: 2,
        defaultWeight: 'PDC',
        notes: '2ᵉ du superset. Coudes serrés, buste vertical. Tempo 2-0-1. 14-18 reps en V10 — ajoute du lest si >15 reps, sinon reste au poids du corps.',
      },
    ],
  },
  ...
  // ── JOUR 6 — LEGS B ────────────────────────────────────────────────────────
  {
    ...
    dayNumber: 6,
    name: 'Legs B',
    focus: 'Récup active, priorité fessiers puis mollets (Phase 0 — décharge, RIR 3-4, jusqu\'au 23/07)',
