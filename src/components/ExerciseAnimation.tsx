...
export const EXERCISE_ANIM_MAP: Record<string, string> = {
  // ── Strict V2.2 (19/08/2026) ──
  'pull-a-1': 'reardelt', 'pull-a-2': 'lateral', 'pull-a-3': 'pullup',
  'pull-a-4': 'curl',     'pull-a-5': 'row',     'pull-a-7': 'squat',
  'pull-a-8': 'crunch',
  'push-a-1': 'lateral',  'push-a-2': 'lateral', 'push-a-3': 'inclinepress',
  'push-a-4': 'fly',      'push-a-5': 'pushdown', 'push-a-6': 'hipthrust',
  'push-a-7': 'calf',     'push-a-8': 'crunch',
  'pull-b-1': 'reardelt', 'pull-b-2': 'reardelt', 'pull-b-3': 'curl',
  'pull-b-4': 'pullup',   'pull-b-5': 'curl',    'pull-b-6': 'hipthrust',
  'pull-b-7': 'calf',     'pull-b-8': 'plank',
  'push-b-1': 'lateral',  'push-b-2': 'lateral', 'push-b-3': 'inclinepress',
  'push-b-4': 'fly',      'push-b-5': 'pushdown', 'push-b-6': 'dip',
  'push-b-7': 'backext',  'push-b-8': 'lunge',   'push-b-9': 'hollow',
  // ── Anciennes journees Legs, gardees pour l'historique ──
  'legs-a-1': 'squat',
